...
namespace Verpha.HierarchyDesigner
{
    public class HierarchyDesigner_Utility_Folder
    {
        ...
        {
            foreach (KeyValuePair<string, HierarchyDesigner_Configurable_Folder.HierarchyDesigner_FolderData> folder in HierarchyDesigner_Configurable_Folder.GetAllFoldersData())
            {

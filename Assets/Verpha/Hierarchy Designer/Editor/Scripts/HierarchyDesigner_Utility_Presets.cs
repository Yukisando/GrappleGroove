...
namespace Verpha.HierarchyDesigner
{
    public static class HierarchyDesigner_Utility_Presets
    {
        ...
        {
            var foldersData = HierarchyDesigner_Configurable_Folder.GetAllFoldersData();
            foreach (string folderName in foldersData.Keys)
            {
                HierarchyDesigner_Configurable_Folder.SetFoldersData(folderName, preset.folderColor, preset.folderImageType);
            }
        }

        public static void ApplyPresetToSeparators(HierarchyDesigner_Configurable_Presets.HierarchyDesigner_Preset preset)
        {
            var separatorsData = HierarchyDesigner_Configurable_Separator.GetAllSeparatorData();

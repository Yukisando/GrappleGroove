...
namespace PrototypeFPC
{
    public class Jump : MonoBehaviour
    {
        ...
        void SimulateJump()
        {
            if(Input.GetKeyDown(jumpKey) && dependencies.isGrounded && !dependencies.isWallRunning && !dependencies.isVaulting && !dependencies.isInspecting && Time.time >= nextTimeToJump)
            {
                //Jump cooldown rate

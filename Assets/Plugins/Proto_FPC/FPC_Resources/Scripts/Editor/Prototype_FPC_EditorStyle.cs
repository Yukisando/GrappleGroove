...
namespace PrototypeFPC
{
    ...
    public class Prototype_FPC_EditorStyle : Editor
    {
        ...
        void OnEnable() {
            ...
            //Tool Image
            toolImage = (Texture)AssetDatabase.LoadAssetAtPath("Assets/Proto_FPC/FPC_Resources/Scripts/Editor/Title.png", typeof(Texture));
        }
        ...
        public override void OnInspectorGUI() {
            ...
            GUILayout.Label(toolImage, new GUIStyle(GUI.skin.label) {
            ...
            var leftAncher = new GUIStyle(GUI.skin.button) {
